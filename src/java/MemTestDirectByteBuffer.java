...
public class MemTestDirectByteBuffer {
    ...
    private static void testMem(ByteBuffer bb, byte memBits) {
        resetSeed();
        ...
        for (int i = 0; i < memSize; i++) {
            result += bb.get((int)rand(memBits)) & 0xff;
        }
    ...
    public static void main(String[] args) {
        ...
        byte memBits = 30;
        ByteBuffer bb = ByteBuffer.allocateDirect(1 << memBits);

        System.out.println("Language: Java");
        System.out.println("Implementation: Direct ByteBuffer");
